...
import { getApprovedOrder } from "../_actions/payment";
import {
  convertToDate,
  convertToTime,
  convertToRupiah
...
class Tickets extends Component {
  ...
  render() {
    const { approved, isLoading, error } = this.props.approvedOrder;
    ...
    return (
      <>
        <div style={{ paddingTop: "10px" }}>
          <h1 style={{ color: "#E74267" }}>Tickets List</h1>
